...
package com.android.build.gradle.tasks.injection.sub;
...
public class SubPackageJavaTasks {
    public static class ValidInputSubTask extends JavaTasks.ValidInputTask {
