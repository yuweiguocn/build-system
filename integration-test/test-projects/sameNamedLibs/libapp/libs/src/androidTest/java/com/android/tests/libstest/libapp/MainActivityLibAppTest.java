...
public class MainActivityLibAppTest {
    @Rule
    public ActivityTestRule<MainActivityLibApp> rule = new ActivityTestRule<>(MainActivityLibApp.class);
    ...
    @Before
    public void setUp() {
        final MainActivityLibApp a = rule.getActivity();
