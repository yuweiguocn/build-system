...
public class OverrideClassFieldRemovalTest {
    ...
    /**
     * this is more complicated than it should be. Our tests have jacoco injected so our .class
     * files contain some jacoco fields, so we make sure that all original fields have been removed
     * from the class.
     */
    @Test
